...
public class ComExecutor implements CommandExecutor, TabCompleter {
    ...
    public ComExecutor(BitAPI plugin) {
        this.plugin = plugin;
    }
    ...
    private void execute(String command, String[] args, Player player) {
        switch(command) {
            ...
            case "set-spectator":
                ...
                break;
            case "info-player":
                InfoPlayerCommand informationCommand = new InfoPlayerCommand(this.plugin);
            ...
            case "randomize-teams":
                RandomizeTeamsCommand randomizeCommand = new RandomizeTeamsCommand(this.plugin);
